...
export class RealExportService {
  ...
  async generatePDF(assessmentId: string): Promise<Uint8Array> {
    ...
    doc.text('Generated by DPIA Agent - https://dpia.avantle.ai', margin, footerY)
...
// Export service singleton - use real or mock based on environment
export const exportService = process.env.NODE_ENV === 'development' 
  ? new MockExportService() 
  : new RealExportService()