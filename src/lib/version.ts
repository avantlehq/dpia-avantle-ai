// Avantle Privacy Platform Version Information - Build Cache Buster v3.21.1
export const VERSION = "3.21.1" as const
export const VERSION_NAME = "FIXED SaaS UI - Proper Navigation Styling" as const
