// Avantle Privacy Platform Version Information - Build Cache Buster v3.20.1
export const VERSION = "3.20.1" as const
export const VERSION_NAME = "Build Fixes - Module Architecture" as const
