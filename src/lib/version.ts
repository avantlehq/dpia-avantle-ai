// DPIA.ai Privacy Platform Version Information - Build Cache Buster v3.19.37
export const VERSION = "3.19.37" as const
export const VERSION_NAME = "Status Chips Redesign - Structured Compact Summary" as const
