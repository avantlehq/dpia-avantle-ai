// Avantle Privacy Platform Version Information - Build Cache Buster v3.21.0
export const VERSION = "3.21.0" as const
export const VERSION_NAME = "Modern SaaS UI - Cohesive Topbar + Sidebar" as const
