// Avantle Privacy Platform Version Information - Build Cache Buster v3.21.18
export const VERSION = "3.21.18" as const
export const VERSION_NAME = "Complete Module Overview Pages - Unified Dashboard UI" as const
