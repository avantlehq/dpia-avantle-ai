// DPIA.ai Privacy Platform Version Information - Build Cache Buster v3.19.36
export const VERSION = "3.19.36" as const
export const VERSION_NAME = "Fix Count Layout - Numbers Next to Labels" as const
