// Avantle Privacy Platform Version Information - Build Cache Buster v3.20.2
export const VERSION = "3.20.2" as const
export const VERSION_NAME = "Final Build Fix - Clean Architecture" as const
