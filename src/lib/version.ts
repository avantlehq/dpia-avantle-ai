// DPIA.ai Privacy Platform Version Information - Build Cache Buster v3.19.38
export const VERSION = "3.19.38" as const
export const VERSION_NAME = "Fix Chip Spacing - Proper Visual Separation" as const
