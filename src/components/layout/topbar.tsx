  ...
  return (
    <header className="flex items-center justify-between px-4 lg:px-6 h-18 border-b border-border bg-background/95 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Non-clickable Version Info - Cache Buster v3.19.27 */}
      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" size="sm" className="h-9 px-3 bg-transparent hover:bg-blue-50 dark:hover:bg-blue-900/30 border-blue-200/50 dark:border-blue-800/50 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200">
        ...
        <Button 
          variant="outline" 
          size="sm" 
          className="h-9 w-9 p-0 bg-transparent hover:bg-purple-50 dark:hover:bg-purple-900/30 border-purple-200/50 dark:border-purple-800/50 hover:border-purple-300 dark:hover:border-purple-700 transition-all duration-200"
