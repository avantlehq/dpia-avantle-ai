    ...
    const translations: Record<string, Record<string, unknown>> = {
      en: {
        ...
        help: {
          ...
          tryAnother: 'Try another keyword or browse categories below',
          sections: {
      ...
      sk: {
        ...
        help: {
          ...
          searchPlaceholder: 'Hľadať v dokumentácii...',
          gettingStartedButton: 'Začíname',
          comingSoonButton: 'Pripravuje sa',
          noResults: 'Nenašli sa žiadne výsledky',
          tryAnother: 'Skúste iné kľúčové slovo alebo prehľadajte kategórie nižšie',
          sections: {
