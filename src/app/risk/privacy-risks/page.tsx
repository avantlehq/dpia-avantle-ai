    ...
    <div className="space-y-6">
      <div className="border-b border-gray-700/50 pb-6">
        ...
        <p className="text-gray-400">
          Identified privacy risks and threats
        </p>
      </div>
      ...
      <div className="bg-gray-800/50 rounded-lg p-8 text-center border border-gray-700/30">
        ...
        <h2 className="text-xl font-semibold text-white mb-2">Privacy Risk Management</h2>
        <p className="text-gray-400 mb-6">
          Identify, assess, and monitor privacy risks to rights and freedoms of data subjects.
        </p>
