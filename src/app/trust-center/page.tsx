...
export default function TrustCenterOverviewPage() {
  return (
    <div className="space-y-6">
      ...
      {/* Increased Spacing Before Trust Center */}
      <div className="mt-12"></div>

      {/* Trust Center Management Table - matching dashboard style */}
      <Card className="avantle-border bg-card backdrop-blur-sm shadow-sm">
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            Audit Packages & Compliance Reports
            <Link href="/trust-center/audit-packages">
              <Button
                variant="outline"
                size="sm"
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-foreground mb-2">Compliance reporting ready</h3>
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Generate comprehensive audit packages and compliance reports for stakeholders and auditors.
            </p>
